...
module vit_tb;
    ...
    vit_top_integrated #(
        .BASE_DIR("C:/Users/DELTA2/Downloads/vit_final/vit_new/export_quantized_new/")
    ) dut (
        .clk(clk),
        .rst(rst),
        .start(start),
    ...
    initial begin
        ...
        int status;
        string IMAGE_FILE = "C:/Users/DELTA2/Downloads/vit_final/vit_new/real_images_new/test_19.mem";
